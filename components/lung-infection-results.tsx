...
export function LungInfectionResults({ data }: LungInfectionResultsProps) {
  const { total_ratio, right_ratio, left_ratio, label, confidence, pleth_status, idsa_ats_patterns, idsa_ats_score, patient_age } = data
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-muted rounded-full h-4">
                  <div
                    className={`h-4 rounded-full ${total_ratio || 0 > 15 ? "bg-destructive" : total_ratio || 0 > 5 ? "bg-yellow-500" : "bg-green-500"
                      }`}
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">{(confidence || 0).toFixed(1)}% confidence in analysis</p>
              </div>
              ...
              <div>
                ...
                {(patient_age !== undefined && patient_age > 0) && (
                  <div>
                    <h4 className="text-xs text-muted-foreground mb-1">Patient Information</h4>
                    ...
                    <div className="p-3 rounded-md text-sm bg-purple-500/10 mt-2">
                      <p className="font-medium">IDSA ATS Score: {idsa_ats_score}</p>
                    </div>

                    {idsa_ats_patterns && Object.keys(idsa_ats_patterns).length > 0 && (
                      <div className="p-3 rounded-md text-sm bg-orange-500/10 mt-2">
                        <p className="font-medium">IDSA ATS Patterns:</p>
                        <ul className="list-disc pl-4">
                          {Object.entries(idsa_ats_patterns || {}).map(([key, value]) => (
                ...
                <div className="aspect-square relative border rounded-md overflow-hidden">
                  <div className="absolute inset-0 grid grid-cols-2 grid-rows-2">
                    <div
                      ...
                      style={{
                        background: `rgba(220, 38, 38, ${(left_ratio?.lt ?? 0 / 100) * 2})`,
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        background: `rgba(220, 38, 38, ${(left_ratio?.rt ?? 0 / 100) * 2})`,
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        background: `rgba(220, 38, 38, ${(left_ratio?.lb ?? 0 / 100) * 2})`,
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        background: `rgba(220, 38, 38, ${(left_ratio?.rb ?? 0 / 100) * 2})`,
                      }}
                    >
                ...
                <div className="aspect-square relative border rounded-md overflow-hidden">
                  <div className="absolute inset-0 grid grid-cols-2 grid-rows-2">
                    <div
                      className="border-r border-b"
                      style={{
                        background: `rgba(220, 38, 38, ${(right_ratio?.lt ?? 0 / 100) * 2})`,
                      }}
                    >
                      <span className="absolute top-1/4 left-1/4 transform -translate-x-1/2 -translate-y-1/2 text-xs font-bold">
                        {right_ratio?.lt ?? 0}%
                    ...
                    <div
                      className="border-l border-b"
                      style={{
                        background: `rgba(220, 38, 38, ${(right_ratio?.rt ?? 0 / 100) * 2})`,
                      }}
                    >
                      <span className="absolute top-1/4 right-1/4 transform translate-x-1/2 -translate-y-1/2 text-xs font-bold">
                        {right_ratio?.rt ?? 0}%
                    ...
                    <div
                      className="border-r border-t"
                      style={{
                        background: `rgba(220, 38, 38, ${(right_ratio?.lb ?? 0 / 100) * 2})`,
                      }}
                    >
                      <span className="absolute bottom-1/4 left-1/4 transform -translate-x-1/2 translate-y-1/2 text-xs font-bold">
                        {right_ratio?.lb ?? 0}%
                    ...
                    <div
                      className="border-l border-t"
                      style={{
                        background: `rgba(220, 38, 38, ${(right_ratio?.rb ?? 0 / 100) * 2})`,
                      }}
                    >
                      <span className="absolute bottom-1/4 right-1/4 transform translate-x-1/2 translate-y-1/2 text-xs font-bold">
                        {right_ratio?.rb ?? 0}%
